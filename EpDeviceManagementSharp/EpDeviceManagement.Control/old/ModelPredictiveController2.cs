...
//public class ModelPredictiveController2 : IEpDeviceController, IDisposable
//{
...
//    public string Name => nameof(ModelPredictiveController2);
...
//    public string PrettyConfiguration => $"{this.predictionHorizon:hh\\:mm} {this.targetBatteryState}";
